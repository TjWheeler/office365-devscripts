...
param(
    ...
    [string] $scope = $(Read-Host "Specify Site|Web"),
...
$web = $context.Web
$context.Load($web)
#Credit: Function from https://sharepoint.stackexchange.com/questions/188014/enable-new-list-experience-on-document-library-programmatically/195126
